...
export default function News() {
  ...
  return (
    <section id="news" className="py-24 bg-theme-bg border-t border-theme-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <span className="text-theme-secondary font-bold tracking-widest uppercase text-sm mb-2 block">Berita & Galeri</span>
            <h2 className="text-3xl md:text-5xl font-bold text-theme-text">
              Cerita <span className="text-theme-primary">Perjalanan</span>
            </h2>
          </div>
          <a href="#" className="flex items-center gap-2 text-theme-muted hover:text-theme-text transition-colors">
          ...
          <div className="space-y-8">
            {posts.slice(1).map((post, index) => (
              <motion.div
                ...
                className="flex flex-col sm:flex-row gap-6 group cursor-pointer bg-theme-surface/30 p-4 rounded-xl border border-theme-border/50 hover:border-zinc-700 transition-colors"
              >
